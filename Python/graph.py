    ...
    for i in range(arg):
        ...
        if x < 0:
            ...
            if x == 0:
                ...
                if q2 > 0:
                    q2 *= -1
                    print('x      ', ((arg//2+1)+25)*'\u2500'+'\u253C'+(q2-1)+'\u2500'+'*'+((arg//2+1)+25-q2)*'\u2500'+' y')
                elif q2 == 0:
                    print('x      ', ((arg//2+1)+25)*'\u2500'+'\u253C'+'*'+((arg//2+1)+20)*'\u2500'+' y')
                elif q2 < 0:
                    q2 *= -1
                    print('x      ', ((arg//2+1)+25-q2-1)*'\u2500'+'*'+q2*'\u2500'+'\u253C'+((arg//2+1)+25)*'\u2500'+' y')
            else:
                if f ==0:
                    print('x      ', ((arg//2+1)+25)*'\u2500'+'\u253C'+((arg//2+1)+25)*'\u2500'+' y')
    ...
    for i in range(arg):
        ...
        if x < 0:
            ...
            if x == 0:
                ...
                if q1 > 0:
                    q1 *= -1
                    print('x      ', ((arg//2+1)+25)*'\u2500'+'\u253C'+(q1-1)+'\u2500'+'*'+((arg//2+1)+25-q1)*'\u2500'+' y')
                elif q1 == 0:
                    print('x      ', ((arg//2+1)+25)*'\u2500'+'\u253C'+'*'+((arg//2+1)+20)*'\u2500'+' y')
                elif q1 < 0:
                    q1 *= -1
                    print('x      ', ((arg//2+1)+25-q1-1)*'\u2500'+'*'+q1*'\u2500'+'\u253C'+((arg//2+1)+25)*'\u2500'+' y')
            else:
                if f ==0:
                    print('x      ', ((arg//2+1)+25)*'\u2500'+'\u253C'+((arg//2+1)+25)*'\u2500'+' y')
